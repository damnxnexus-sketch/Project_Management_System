...
export function TopNav() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-[var(--border-color)] bg-[var(--background)]/80 px-6 backdrop-blur-md">
      <div className="flex w-full max-w-md items-center gap-2 rounded-md border border-[var(--border-color)] bg-[var(--glass-bg)] px-3 py-1.5 focus-within:ring-2 focus-within:ring-[var(--accent)] transition-all">
