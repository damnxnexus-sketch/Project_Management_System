...
import { LayoutDashboard, FolderKanban, Users, Sparkles, LogOut, CalendarCheck, Video, Search, BarChart3, CheckSquare } from 'lucide-react';
...
const navItems = [
  ...
  { name: 'Daily Updates', href: '/daily-updates', icon: CheckSquare },
